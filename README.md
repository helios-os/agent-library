...
AI becomes most useful when it can perform clear tasks.
...
The Agent Library explores agents such as:

### Receipt Agent
Extracts structured data from receipts and invoices.

### Visibility Agent
Analyzes business information and prepares it for AI discovery systems.

### Knowledge Agent
Transforms business expertise into structured machine-readable formats.
